...
% SETTINGS_GUI_SEGMENTATION the settings for the segmentation
...
% Nuclei ------------------------------------------------------------------
% Editbox to enter the amount of clusters for k-means
...
% Editbox to enter the minimum amount of voxels needed for a nucleus
...
% Editbox to enter the minimum amount of voxels needed for a landmark cell
...
% Editbox to enter the size of the morphological opening filter
...
% Editbox to enter the size of the morphological closing filter
...
% Editbox to enter the minimum amount of voxels needed for a tissue part
...
%--------------------------------------------------------------------------
    ...
    % Function to save all changes to the parameters
