...
% Checkbox to enable/disable centering during PCA
...
checkbox_pca = uicontrol('Style', 'checkbox', ....
    'Value', p.ellipsoidFitting.pcaCentered, ...
...
%--------------------------------------------------------------------------
    ...
    function saving_callback(source, eventdata)
        ...
        p.ellipsoidFitting.pcaCentered = checkbox_pca.Value;
    end
