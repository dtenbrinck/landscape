...
% SETTINGS_GUI_PREPROCESSING the settings for the preprocessing in the
% registration step
...
% Editbox to enter a scaling factor for the data
...
% Editboxes to enter the filter sizes for all channels
...
%--------------------------------------------------------------------------
    ...
    % Function to save all changes to parameters
