...
% SETTINGS_GUI_REGISTRATION the settings for the registration process
...
% Editbox to enter the reference position on the landmark
...
% Editbox to enter the target point on the unit sphere as an angle
box_reference_angle = uicontrol('Style', 'text', ...
    'String', 'Target Point [deg]:', ...
    'HorizontalAlignment', 'left', ...
    'FontName', 'Arial', ...
    'FontSize', 10, ...
...
% Box to select whether to flip the registration or not
...
% Editbox to enter the sphere resolution
...
% Editboxes to enter the resolution of the reference cube
