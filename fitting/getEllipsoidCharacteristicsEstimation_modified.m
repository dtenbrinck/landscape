...
function [ center, radii, axis, max_iterations_reached ] ...
...
[radii, center, max_iterations_reached] = approximateEllipsoidParamsWithDescentMethod(v_initial, W, funct, grad_funct, fittingParams.descentMethod, max_iterations_reached);
...
function [radii, center, max_iterations_reached] = approximateEllipsoidParamsWithDescentMethod(v0, W, funct, grad_funct, method, max_iterations_reached)
    try
        [v, max_iterations_reached] = performGradientSteps(v0, W, funct, grad_funct, method, max_iterations_reached);
...
function [v, max_iterations_reached] = performGradientSteps(v, W, funct, grad_funct, method, max_iterations_reached)    
    tic;
    Wv = W*v;    
