...
%SEGMENTGFP function to segment data in the landmark channel and tissue
%data in the probe channel.
%   This function uses the in p selected clustering algorithm to segment
%   the data in the landmark or probe channel into signal and background. The default
%   method is k-means.
