...
referenceLandmark.MIP = zeros(parameter.samples_cube(2), ...
    parameter.samples_cube(1));
referenceLandmark.coords = zeros(parameter.samples_cube(2),...
    parameter.samples_cube(1),parameter.samples_cube(3));
