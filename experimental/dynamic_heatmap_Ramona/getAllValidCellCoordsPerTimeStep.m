function [ allCellCoords ] = getAllValidCellCoordsPerTimeStep(sizeAcc,fileNames,tole,resultsPathAccepted, cellCoordinates)
...
allCellCoords = horzcat(allCellCoords, cellCoordinates);
