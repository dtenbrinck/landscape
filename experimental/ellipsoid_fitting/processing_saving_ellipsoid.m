...
parfor experiment=1:numberOfExperiments
    ...
    try
        ...
        ellipsoid = estimateEmbryoSurface(processedData.nucleiCoordinates, p.resolution, p.ellipsoidFitting, [p.resultsPath '/' experimentData.filename '_ellipsoid_fitting']);
