%Segment a single, given channel and save and return the results
function [binaryX, OriginalData] =  AtlasSegmentationSingleTemp(dname, p)
...
if p.debug_level >= 1; disp('thresholding image...'); end
% Preallocation
...
if p.debug_level >= 1; disp('Finding connected blobs...'); end
...
if p.debug_level >= 1; disp('Creating a gif...'); end
for t=1:80
...
if p.debug_level >= 1; disp('Saving data...'); end
