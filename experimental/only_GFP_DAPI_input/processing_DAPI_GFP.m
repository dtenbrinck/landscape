...
for experiment=1:numberOfExperiments
    ...
    try
        ...
        plotEllipsoidAndNucleiAfterRotation (processedData.nucleiCoordinates, ellipsoid, experiment,p.resolution, rotationMatrix, p.resolution, transformationMatrix);
