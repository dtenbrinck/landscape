function [ ellipsoidEstimation ] = estimateEmbryoSurface( nuclei_coord, resolution, ellipsoidFittingParams, expNumber)
...
if (  ellipsoidFittingParams.visualization ) 
   ...
   if isreal(ellipsoidEstimation.center) && isreal(ellipsoidEstimation.radii)
    ...
    %saveas(gcf, ['_' num2str(expNumber) '_estimated_ellipsoid_view1.png']);
    %view(2); saveas(gcf, ['_' num2str(expNumber) '_estimated_ellipsoid_view2.png']);
    %view(3); saveas(gcf, ['_' num2str(expNumber) '_estimated_ellipsoid_view3.png']);
