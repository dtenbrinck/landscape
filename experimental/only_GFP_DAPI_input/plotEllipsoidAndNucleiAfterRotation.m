function plotEllipsoidAndNucleiAfterRotation (nucleiOrigCoord, ellipsoidEstimation, expNumber, resolution, rotationMatrix, transformationMatrix)
    ...
    [x,y,z] = reshapeXYZ(rotatedCoordinates, center);
    ...
    [x,y,z] = reshapeXYZ(rotatedCoordinates, [0,0,0]);
    
    subplot(1,3,3);
    hold on;
    plotEllipsoids(X, x,y,z);
    plotOrientationVectors( [0,0,0], ((transformationMatrix * rotationMatrix' )\ axes')', [1 1 1]);
...
function [x,y,z] = reshapeXYZ(rotatedCoordinates, center)
