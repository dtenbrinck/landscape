...
subplot(3,2,1); imagesc((gatheredData.experiment.DapiMIP)); title('Original DAPI channel'); axis image;
subplot(3,2,2); imagesc((gatheredData.experiment.GFPMIP)); title('Original GFP channel'); axis image;

% visualize segmentation results in preprocessed data
subplot(3,2,3); imagesc((gatheredData.processed.DapiMIP)); title('Segmentation in processed DAPI channel'); axis image;
...
subplot(3,2,4); imagesc((gatheredData.processed.GFPMIP)); title('Segmentation in processed GFP channel'); axis image;
