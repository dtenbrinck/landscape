function [landmarkShell, aboveLandmark, belowLandmark] = computeLandmarkShell(all_PGC_coords, p, fileNames, numberOfResults)
...
for result = 1:numberOfResults
    ...
    landmarkShell = getShell(all_PGC_coords, mean_radii(2), mean_radii(1));
    aboveLandmark = getShell(all_PGC_coords, mean_radii(1)+eps, Inf);
    belowLandmark = getShell(all_PGC_coords, 0, mean_radii(2)-eps);
